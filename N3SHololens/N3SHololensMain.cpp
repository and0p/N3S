...
N3SHololensMain::N3SHololensMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
    ...
    m_locatabilityChangedToken =
        m_locator->LocatabilityChanged +=
            ref new Windows::Foundation::TypedEventHandler<SpatialLocator^, Object^>(
                std::bind(&N3SHololensMain::OnLocatabilityChanged, this, _1, _2)
                );
    ...
    m_cameraAddedToken =
        m_holographicSpace->CameraAdded +=
            ref new Windows::Foundation::TypedEventHandler<HolographicSpace^, HolographicSpaceCameraAddedEventArgs^>(
                std::bind(&N3SHololensMain::OnCameraAdded, this, _1, _2)
                );
    ...
    m_cameraRemovedToken =
        m_holographicSpace->CameraRemoved +=
            ref new Windows::Foundation::TypedEventHandler<HolographicSpace^, HolographicSpaceCameraRemovedEventArgs^>(
                std::bind(&N3SHololensMain::OnCameraRemoved, this, _1, _2)
                );
...
void N3SHololensMain::UnregisterHolographicEventHandlers()
{
...
N3SHololensMain::~N3SHololensMain()
{
...
HolographicFrame^ N3SHololensMain::Update()
{
...
bool N3SHololensMain::Render(Windows::Graphics::Holographic::HolographicFrame^ holographicFrame)
{
...
void N3SHololensMain::SaveAppState()
{
    //
...
void N3SHololensMain::LoadAppState()
{
    //
...
void N3SHololensMain::OnDeviceLost()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void N3SHololensMain::OnDeviceRestored()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void N3SHololensMain::OnCameraAdded(
...
void N3SHololensMain::OnCameraRemoved(
    HolographicSpace^ sender,
