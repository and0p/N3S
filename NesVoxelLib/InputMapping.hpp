...
enum N3SFunction {
	...
	editor_flip_sprite_h, editor_flip_sprite_v, editor_reset_sprite,
	editor_moveleft, editor_moveright, editor_moveup, editor_movedown,
	voxeleditor_select_left, voxeleditor_select_up, voxeleditor_select_right, voxeleditor_select_down,
...
const FunctionMapping functionMap[FUNCTION_COUNT] = {
	...
	{ cam_move_left, "MOVE CAMERA LEFT", true, "H", "" },
	{ cam_move_right, "MOVE CAMERA RIGHT", true, "L", "" },
	{ cam_move_up, "MOVE CAMERA UP", true, "K", "" },
	{ cam_move_down, "MOVE CAMERA DOWN", true, "J", "" },
	...
	{ editor_flip_sprite_h, "FLIP HORIZONTAL", false, "U", "" },
	{ editor_flip_sprite_v, "FLIP VERTICAL", false, "I", "" },
	{ voxeleditor_select_left, "SELECT_LEFT", false, "H", "" },
	{ voxeleditor_select_down, "SELECT_LEFT", false, "J", "" },
	{ voxeleditor_select_up, "SELECT_LEFT", false, "K", "" },
	{ voxeleditor_select_right, "SELECT_LEFT", false, "L", "" }
};