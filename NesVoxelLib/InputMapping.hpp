...
const FunctionMapping functionMap[FUNCTION_COUNT] = {
	...
	{ selection_add, "SELECTION ADD", false, "", "" },
	{ selection_remove, "SELECTION REMOVE", false, "", "" },
	{ selection_copy, "SELECTION COPY", false, "", "" },
	{ selection_delete, "SELECTION DELETE", false, "", "" },
	{ selection_deselect, "SELECTION DESELECT", false, "ESCAPE", "" },
	{ editor_moveleft, "EDITOR MOVE LEFT", false, "", "" },
	{ editor_moveright, "EDITOR MOVE RIGHT", false, "", "" },
	{ editor_moveup, "EDITOR MOVE UP", false, "", "" },
	{ editor_movedown, "EDITOR MOVE DOWN", false, "", "" },
	...
	{ editor_copy, "EDITOR COPY", false, "", "" },
	{ editor_paste, "EDITOR PASTE", false, "", "" },
	{ palette_copy, "PALETTE COPY", false, "", "" },
	{ palette_paste, "PALETTE PASTE", false, "", "" },
};